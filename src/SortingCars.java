...
/**
 *
 * @author omarfrometa Test Assignment for Educational Network
 */
public class SortingCars implements SortAlgorithm {

    public static int totalCars = 1000;
    ...
    public static void main(String[] args) throws FileNotFoundException, UnsupportedEncodingException {
         ...
         */
         ...
         Thread1 T1 = new Thread1(cars);
         T1.start();
         
         Thread2 T2 = new Thread2(cars);
         T2.start();
         
         Thread3 T3 = new Thread3(cars);
         T3.start();
